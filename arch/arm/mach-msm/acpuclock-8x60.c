...
#define L_VAL_SCPLL_CAL_MAX	0x23 /* = 1512 MHz with 27MHz source */
...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[15] = {1188000,  1, 0x16, 1200000, 1200000, 3},
        ...
        [21] = {1512000,  1, 0x1C, 1200000, 1300000, 3},
        ...
        [27] = {1836000,  1, 0x22, 1350000, 1450000, 3},
        [28] = {1890000,  1, 0x23, 1350000, 1450000, 3},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_v2[] = {
  ...
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(20), 1275000, 0x03006000},
  { {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(20), 1300000, 0x03006000},
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(21), 1325000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(21), 1350000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(22), 1375000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(22), 1400000, 0x03006000},
  { {1, 1}, 1890000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(23), 1425000, 0x03006000},
  { {0, 0}, 0 },
};
